...
from src import Program, pipelined_cpu, control
...
benchmarks = [
    ...
    Program(
        ...
        data_mem={0x40: 0xCAFEBABE, 0x41: 0xBEFEBACA},
    ),
    # Test loading/storing to data_mem while branching
    Program(
        name="mem2",
        instructions=[
            # main:
        ...
        data_mem={0: 5, 1: 6, 2: 7, 3: 8, 4: 9, 32: 5, 33: 6, 34: 7, 35: 8, 36: 9},
    ),
...
if __name__ == "__main__":
    ...
    pipelined_cpu(num_stages=num_stages)  # Instantiate the CPU design

    print(f"Testing {num_stages}-stage pipelined CPU design")
